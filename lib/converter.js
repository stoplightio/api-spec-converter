...
Converter.prototype.mapData = function() {
  ...
  if (this.importer.getEndpoints().length <= 0 && this.importer.getEndpointGroups().length <= 0) {
    this.importer.map()
  }
}

Converter.prototype.loadFile = function (filePath) {
  return this.importer.loadFile(filePath)
}
...
Converter.prototype.getSLEndpoints = function() {
  this.mapData()
  return this.importer.getEndpoints()
}

Converter.prototype.getSLEndpointGroups = function() {
  this.mapData()
  return this.importer.getEndpointGroups()
}

Converter.prototype.getSLSchemas = function() {
  this.mapData()
  return this.importer.getSchemas()
}

Converter.prototype.getConvertedData = function (format) {
  this.mapData()
  this.exporter.loadData(this.importer.getEndpoints(), this.importer.getEndpointGroups())
  this.exporter.loadSchema(this.importer.getSchemas())
  this.exporter.map()
