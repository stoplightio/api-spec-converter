...
RAML.prototype._export = function () {
  ...
  for(var i in endpoints) {
    ...
    if (endpoint.Method.toLowerCase() === 'post' ||
      ...
      var mimeType = (endpoint.Consumes && endpoint.Consumes.length > 0) ? endpoint.Consumes[0]:'';
    ...
    var mimeType = (endpoint.Produces && endpoint.Produces.length > 0) ? endpoint.Produces[0]:'';
