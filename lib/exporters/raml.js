...
RAML.prototype._validateParam = function(params) {
  ...
  for(var key in params) {
    ...
    if (params[key].type !== 'string' && (params[key].maxLength || params[key].minLength)) {
      //min/max lengths aren't supported in RAML
      delete params[key].maxLength;
      delete params[key].minLength;
    }
  }
  return params;
};
