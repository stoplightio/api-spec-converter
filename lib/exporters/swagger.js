...
Swagger.prototype._getUniqueOperationId = function(endpoint) {
  var endpoints = this.project.Endpoints, operationId = endpoint.Name;
  for(var i in endpoints) {
    if (endpoints[i].Method === endpoint.Method && endpoints[i].Path === endpoint.Path) {
      continue;
    }
...
Swagger.prototype._constructSwaggerMethod = function(endpoint, parameters, responses, env) {
  var resultSwaggerMethod = {
    ...
    operationId: this._getUniqueOperationId(endpoint),
