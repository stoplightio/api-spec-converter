...
StopLightX.prototype._import = function() {
  ...
  for (var functionsKey in data[prefix].functions) {
    var ufData = data[prefix].functions[functionsKey];
  ...
  for (var textSectionsKey in data[prefix].textSections) {
    var txtData = data[prefix].textSections[textSectionsKey];
  ...
  for(var endpointsKey in this.project.Endpoints) {
    var endpoint = this.project.Endpoints[endpointsKey];
  ...
  for(var schemaKey in this.project.Schemas) {
    var schema = this.project.Schemas[schemaKey];
