...
StopLight.prototype.map = function () {
  ...
  this.project.Environment = {
    host: this.data.project.environment.forwardHost,
    basePath: this.data.project.environment.basePath,
  }

  console.log(this.project.Environment)
  ...
  this.project.Schemas = this.data.schemas
  return
}
