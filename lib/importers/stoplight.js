...
StopLight.prototype._import = function () {
  ...
  for (var i in this.data.project.securitySchemas) {
    var ssData = this.data.project.securitySchemas[i];
    //TODO add securityschema entity and map to that
    this.project.addSecuritySchema(ssData);
  }
