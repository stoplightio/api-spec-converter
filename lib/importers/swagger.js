...
Swagger.prototype.map = function() {
  ...
  var defaultReqContentType = this.data.consumes[0], defaultResContentType = this.data.produces[0]
  this.project = new Project(this.data.info.title)
  this.project.Description = this.data.info.description || ''

  this.project.basePath = this.data.basePath || ''
  this.project.host = this.data.host || ''
