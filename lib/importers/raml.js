...
RAML.prototype.createEndpoint = function(me, resource, baseURI) {
  ...
  for (var i = 0; i < resource.methods.length; i++) {
    ...
    var endpoint = new Endpoint(method.displayName || (resource.displayName + '-' + method.method))
...
RAML.prototype.map = function() {
  ...
  var parsedURL = url.parse(this.data.baseUri || 'localhost')
  this.project.Environment.Host = parsedURL.host
